...
const Checkout = () => {
  ...
  useEffect(() => {
    ...
    if (totalPrice > 0) {
      setInstallments(calculateIntallmentes())
    }
  }, [totalPrice])
        ...
        <Card title="Muito obrigado">
          <>
            <p>
              ...
              <br />
              Forma de pagamento:{' '}
              {payWidthCard ? 'Cartão de crédito' : 'Boleto bancário'}
            </p>
          ...
          <Card title="Pagamento">
            <>
              ...
              <S.TabButton
                ...
                type="button"
              >
                <img src={creditCard} alt="Cartão de rcrédito" />
                Cartão de crédito
              </S.TabButton>
